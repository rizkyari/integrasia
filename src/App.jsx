    ...
    <>
      <div className='min-h-screen bg-gray-100 p-6'>
        ...
        <div className='bg-white rounded-lg shadow p-4 mb-6'>
          <h2 className="text-2xl font-bold mb-4">Daftar Hewan Peliharaan</h2>
          <div className='flex justify-center mb-6 gap-4'>
            <button onClick={handleSortAsc} className='px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 border border-green-800'>
              Sort Favorite Asc
            </button>
            <button onClick={handleSortDesc} className='px-4 py-2 bg-purple-500 text-white rounded hover:bg-purple-600 border border-purple-800'>
              Sort Favorite Dsc
            </button>
            <button onClick={handleReplaceBreed} className='px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 border border-yellow-800'>
